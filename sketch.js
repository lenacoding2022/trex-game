...
function setup() {
  ...
  ground = createSprite(100, windowHeight-200);
  ...
  invisibleGround = createSprite(100, windowHeight-150,windowWidth,10);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") ||touches.length>0 && trex.y >= windowHeight/2 +200) {
      trex.velocityY = -12;
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(windowWidth, windowHeight-90,40,10);
